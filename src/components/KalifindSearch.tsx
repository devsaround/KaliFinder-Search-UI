            ...
            <DrawerContent className="z-[100000] flex max-h-[93vh] flex-col">
                      ...
                      <div className="grid grid-cols-4 gap-2 pt-4">
                        {availableSizes.map((size) => (
                          <div
                            ...
                            className={`my-border rounded-lg py-2 text-center text-xs font-medium sm:py-3 sm:text-sm ${filters.sizes.includes(size) ? 'bg-primary text-primary-foreground' : ''
                              }`}
                          >
                            {size}
                          </div>
              ...
              <div className="bg-background mt-auto">
                ...
                <div className="border-border flex gap-2 border-t p-4">
                  ...
                  <DrawerClose asChild>
                    <button
                      className={`bg-primary text-primary-foreground hover:bg-primary-hover rounded-lg py-3 text-sm font-medium transition-colors ${isAnyFilterActive ? 'flex-1' : 'w-full'
                        }`}
                    >
                      ...
                      <div className="grid grid-cols-4 gap-2">
                        {availableSizes.map((size) => (
                          <button
                            ...
                            disabled={!hasSearched}
                            className={`my-border rounded py-2 text-xs font-medium disabled:cursor-not-allowed disabled:opacity-50 lg:text-sm ${filters.sizes.includes(size) ? 'bg-primary text-primary-foreground' : ''
                              }`}
                          >
                            {size}
                          </button>
                ...
                <div onClick={(e) => e.stopPropagation()}>
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button
                        data-sort-button
                        className="group text-foreground hover:border-purple-400 hover:bg-purple-50 flex items-center gap-2 rounded-lg border-2 border-gray-300 bg-white px-3 py-2 text-sm font-medium transition-all focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-none lg:px-4 lg:py-2.5"
                      >
                        <svg
                        ...
                        <ChevronDown className="text-muted-foreground group-hover:text-primary h-4 w-4 transition-transform group-data-[state=open]:rotate-180" />
                      </button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent
                      align="end"
                      className="bg-background border-border z-[2147483647] min-w-[220px] rounded-lg border shadow-xl"
                    >
                      <DropdownMenuLabel className="text-foreground px-3 py-2 text-xs font-bold uppercase tracking-wide">
                        Sort by
                      </DropdownMenuLabel>
                      ...
                      <DropdownMenuItem
                        ...
                        className={`group mx-1 cursor-pointer rounded-md px-3 py-2.5 text-sm transition-colors hover:bg-purple-50 ${sortOption === 'default' ? 'bg-purple-100 font-semibold text-purple-700' : 'text-foreground'
                          }`}
                      >
                      ...
                      <DropdownMenuItem
                        ...
                        className={`group mx-1 cursor-pointer rounded-md px-3 py-2.5 text-sm transition-colors hover:bg-purple-50 ${sortOption === 'a-z' ? 'bg-purple-100 font-semibold text-purple-700' : 'text-foreground'
                          }`}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                      ...
                      <DropdownMenuItem
                        ...
                        className={`group mx-1 cursor-pointer rounded-md px-3 py-2.5 text-sm transition-colors hover:bg-purple-50 ${sortOption === 'z-a' ? 'bg-purple-100 font-semibold text-purple-700' : 'text-foreground'
                          }`}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                      ...
                      <DropdownMenuItem
                        ...
                        className={`group mx-1 cursor-pointer rounded-md px-3 py-2.5 text-sm transition-colors hover:bg-purple-50 ${sortOption === 'price-asc' ? 'bg-purple-100 font-semibold text-purple-700' : 'text-foreground'
                          }`}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                      ...
                      <DropdownMenuItem
                        ...
                        className={`group mx-1 cursor-pointer rounded-md px-3 py-2.5 text-sm transition-colors hover:bg-purple-50 ${sortOption === 'price-desc' ? 'bg-purple-100 font-semibold text-purple-700' : 'text-foreground'
                          }`}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
