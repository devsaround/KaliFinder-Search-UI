...
const CategoryTreeNode: React.FC<{
  ...
  getFacetCount,
    ...
    return (
      <div>
        <label
          className={`flex cursor-pointer items-center justify-between rounded-lg p-2 transition-all ${isSelected ? 'bg-purple-50 ring-2 ring-purple-600 ring-inset' : 'hover:bg-gray-50'
            }`}
        ...
        >
          <div className="flex flex-1 items-center gap-2">
            {hasChildren && (
              ...
              >
                <ChevronDown
                  className={`h-4 w-4 text-gray-600 transition-transform ${isExpanded ? 'rotate-0' : '-rotate-90'
                    }`}
                  aria-hidden="true"
                />
              </button>
            ...
            <div className="flex flex-1 items-center gap-3">
              ...
              <span
                className={`text-sm font-medium select-none ${isSelected ? 'text-purple-900' : 'text-gray-900'
                  }`}
              >
                {node.name
                  .split(' ')
          ...
          <span
            className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${isSelected ? 'bg-purple-100 text-purple-700' : 'bg-gray-100 text-gray-600'
              }`}
          >
            ...
            <div className="mx-auto flex max-w-7xl items-center justify-between gap-2 px-3 sm:gap-4 sm:px-4 lg:gap-6 lg:px-6">
              ...
              <div className="relative flex flex-1 items-center gap-2">
                ...
                <button
                  ...
                  className={`hidden items-center gap-1.5 rounded-lg px-2.5 py-3 text-xs font-medium transition-all sm:flex sm:gap-2 sm:px-3 ${suggestionsEnabled
                      ...
                      <AccordionContent className="pt-3">
                        <div className="space-y-1">
                          {availableBrands.map((brand) => (
                            <label
                              key={brand}
                              className={`flex cursor-pointer items-center justify-between rounded-lg p-2 transition-all ${filters.brands.includes(brand)
                        ...
                        <div className="grid grid-cols-4 gap-2">
                          {availableSizes.map((size) => (
                            <div
                              ...
                              className={`my-border rounded-lg py-2 text-center text-xs font-medium sm:py-3 sm:text-sm ${filters.sizes.includes(size)
                      ...
                      <AccordionContent className="pt-3">
                        <div className="space-y-1">
                          {availableTags.map((tag) => (
                            <label
                              key={tag}
                              className={`flex cursor-pointer items-center justify-between rounded-lg p-2 transition-all ${filters.tags.includes(tag)
                                  ? 'bg-purple-50 ring-2 ring-purple-600 ring-inset'
                                  : 'hover:bg-gray-50'
                                }`}
                            >
                      ...
                      <AccordionContent className="pt-3">
                        <div className="space-y-1">
                          {['In Stock', 'Out of Stock', 'On Backorder'].map((status) => (
                            <label
                              key={status}
                              className={`flex cursor-pointer items-center justify-between rounded-lg p-2 transition-all ${filters.stockStatus.includes(status)
                                  ? 'bg-purple-50 ring-2 ring-purple-600 ring-inset'
                                  : 'hover:bg-gray-50'
                                }`}
                            >
                      ...
                      <AccordionContent className="pt-3">
                        <div className="space-y-1">
                          {['Featured', 'Not Featured'].map((status) => (
                            <label
                              key={status}
                              className={`flex cursor-pointer items-center justify-between rounded-lg p-2 transition-all ${filters.featuredProducts.includes(status)
                                  ? 'bg-purple-50 ring-2 ring-purple-600 ring-inset'
                                  : 'hover:bg-gray-50'
                                }`}
                            >
                      ...
                      <AccordionContent className="pt-3">
                        <div className="space-y-1">
                          {['On Sale', 'Not On Sale'].map((status) => (
                            <label
                              key={status}
                              className={`flex cursor-pointer items-center justify-between rounded-lg p-2 transition-all ${filters.saleStatus.includes(status)
                                  ? 'bg-purple-50 ring-2 ring-purple-600 ring-inset'
                                  : 'hover:bg-gray-50'
                                }`}
                            >
                ...
                <div className="flex gap-3 p-4">
                  ...
                  <DrawerClose asChild>
                    <button
                      ...
                      className={`bg-primary text-primary-foreground hover:bg-primary-hover min-h-[48px] rounded-lg py-3 text-sm font-semibold transition-colors active:scale-[0.98] ${isAnyFilterActive ? 'flex-1' : 'w-full'
                        }`}
                    >
                      Done
                    </button>
                        ...
                        {isInitialLoading ? (
                          ...
                          availableBrands.map((brand) => {
                            ...
                            return (
                              <label
                                key={brand}
                                className={`flex cursor-pointer items-center justify-between rounded-lg p-2 transition-all ${isActive
                                    ? 'bg-purple-50 ring-2 ring-purple-600 ring-inset'
                                    : 'hover:bg-gray-50'
                                  }`}
                              >
                          ...
                          {availableSizes.map((size) => {
                            ...
                            return (
                              <button
                                key={size}
                                onClick={() => handleSizeChange(size)}
                                className={`my-border rounded py-2 text-xs font-medium transition-all lg:text-sm ${isActive
                          ...
                          {availableColors.map((color) => {
                            ...
                            return (
                              <button
                                key={color}
                                onClick={() => handleColorChange(color)}
                                className={`h-6 w-6 rounded-full border-2 transition-all lg:h-8 lg:w-8 ${isActive
                    ...
                    <DropdownMenu>
                      ...
                      >
                        ...
                        <DropdownMenuItem
                          ...
                          className={`group cursor-pointer rounded-lg px-3 py-2.5 text-sm transition-all ${sortOption === 'default'
                        ...
                        <DropdownMenuItem
                          ...
                          className={`group cursor-pointer rounded-lg px-3 py-2.5 text-sm transition-all ${sortOption === 'a-z'
                              ? 'bg-purple-100 font-semibold text-purple-700 shadow-sm'
                              : 'text-gray-700 hover:bg-purple-50'
                            }`}
                        >
                        ...
                        <DropdownMenuItem
                          ...
                          className={`group cursor-pointer rounded-lg px-3 py-2.5 text-sm transition-all ${sortOption === 'z-a'
                              ? 'bg-purple-100 font-semibold text-purple-700 shadow-sm'
                              : 'text-gray-700 hover:bg-purple-50'
                            }`}
                        >
                        ...
                        <DropdownMenuItem
                          ...
                          className={`group cursor-pointer rounded-lg px-3 py-2.5 text-sm transition-all ${sortOption === 'price-asc'
                              ? 'bg-purple-100 font-semibold text-purple-700 shadow-sm'
                              : 'text-gray-700 hover:bg-purple-50'
                            }`}
                        >
                        ...
                        <DropdownMenuItem
                          ...
                          className={`group cursor-pointer rounded-lg px-3 py-2.5 text-sm transition-all ${sortOption === 'price-desc'
                              ? 'bg-purple-100 font-semibold text-purple-700 shadow-sm'
                              : 'text-gray-700 hover:bg-purple-50'
                            }`}
                        >
