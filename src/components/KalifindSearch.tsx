    ...
    const fetchRecommendations = useCallback(async () => {
      ...
      try {
        ...
        if (shouldFetchAllProducts) {
          ...
          result = allProductsWrapped && allProductsWrapped.success ? allProductsWrapped.data : allProductsWrapped;
        } else {
          ...
          if (!response.ok) {
            ...
            result = fallbackWrapped && fallbackWrapped.success ? fallbackWrapped.data : fallbackWrapped;
          } else {
