...
const KalifindSearch: React.FC = () => {
  ...
  const mockProducts: Product[] = [
    ...
    },
    {
      ...
      name: "Sunglass",
      image:
        "https://images.unsplash.com/photo-1556306535-0f09a537f0a3?w=300&h=200&fit=crop",
      originalPrice: 140,
      currentPrice: 120,
      category: "Men",
      color: "black",
    ...
    (async function fetchData() {
      try {
        const response = await fetch(
          `${import.meta.env.VITE_BACKEND_URL}/v1/all`,
          {
            method: "GET",
          },
        );
        ...
        if (Array.isArray(result)) {
          const mappedProducts = result.map((item: any) => {
            const src = item._source || {};
            return {
              id: src.id || item.id || "",
              name: src.name || "",
              image: src.imageUrl || src.image || "",
              originalPrice: src.originalPrice != null ? src.originalPrice : 0,
              currentPrice: src.currentPrice != null ? src.currentPrice : 0,
              category: src.category || "",
              color: src.color || "",
              sizes: Array.isArray(src.sizes)
                ? src.sizes
      ...
      <header className="!bg-background !py-3">
        <div className="!flex !items-center justify-between lg:!gap-24 !max-w-7xl flex-col lg:flex-row">
          <div className="!flex !items-center !gap-2 justify-between md:justify-normal">
            {/* // Option 1: Basic responsive image that scales with container */}
            <div className="!flex !items-center">
              <a href="/" className="!flex !items-center">
                <img
                  src={`${import.meta.env.VITE_EMBED_URL}/KalifindLogo.png`}
                  alt="Kalifind"
            ...
            >
              <div className="!relative !flex-1">
                ...
                <input
                  ...
                  placeholder="Search"
                  // className="!w-full !pl-10 !pr-4 !py-3 !bg-search-bar !border !border-search-highlight !rounded-full !text-foreground !placeholder-muted-foreground focus:!outline-none focus:!ring-2 focus:!ring-search-highlight focus:!border-transparent"
              ...
              <div className="!absolute !top-full !left-0 !right-0 !bg-background !border !border-border !rounded-lg !shadow-lg !z-50 !mt-1">
                <div className="!p-4">
                  <div className="!flex !items-center !justify-between !mb-3">
                    ...
                    {/* <span className="!text-xs !bg-red-100 !text-red-600 !px-2 !py-1 !rounded !uppercase"> */}
                    {/*   LIVE */}
                    {/* </span> */}
                  </div>
                  ...
                  {/*       You searched for {searchQuery}. We have different sizes, */}
                  {/*       colors, brands that goes well for your choice. */}
                  {/*     </p> */}
                  {/*   </div> */}
                  {/* )} */}
                </div>
