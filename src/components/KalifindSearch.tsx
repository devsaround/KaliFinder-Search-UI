                      ...
                      <div className="grid grid-cols-4 gap-2">
                        {availableSizes.map((size) => (
                          <button
                            key={size}
                            onClick={() => handleSizeChange(size)}
                            className={`my-border rounded py-2 text-xs font-medium lg:text-sm ${filters.sizes.includes(size) ? 'bg-primary text-primary-foreground' : ''
                              }`}
                          >
                            {size}
                          </button>
                      ...
                      <div className="flex gap-[8px]">
                        {availableColors.map((color) => (
                          <button
                            key={color}
                            onClick={() => handleColorChange(color)}
                            className={`h-6 w-6 rounded-full border-2 lg:h-8 lg:w-8 ${filters.colors.includes(color)
