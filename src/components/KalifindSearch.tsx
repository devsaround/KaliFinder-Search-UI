                ...
                <div onClick={(e) => e.stopPropagation()}>
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button
                        data-sort-button
                        className="group text-foreground flex items-center gap-2 rounded-lg border-2 border-gray-300 bg-white px-3 py-2 text-sm font-medium transition-all hover:border-purple-400 hover:bg-purple-50 focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-none lg:px-4 lg:py-2.5"
                      >
                        <svg
                    ...
                    >
                      <DropdownMenuLabel className="text-foreground px-3 py-2 text-xs font-bold tracking-wide uppercase">
                        Sort by
                      </DropdownMenuLabel>
                      ...
                      <DropdownMenuItem
                        ...
                        className={`group mx-1 cursor-pointer rounded-md px-3 py-2.5 text-sm transition-colors hover:bg-purple-50 ${sortOption === 'default'
                      ...
                      <DropdownMenuItem
                        ...
                        className={`group mx-1 cursor-pointer rounded-md px-3 py-2.5 text-sm transition-colors hover:bg-purple-50 ${sortOption === 'a-z'
                          ? 'bg-purple-100 font-semibold text-purple-700'
                          : 'text-foreground'
                          }`}
                      >
                      ...
                      <DropdownMenuItem
                        ...
                        className={`group mx-1 cursor-pointer rounded-md px-3 py-2.5 text-sm transition-colors hover:bg-purple-50 ${sortOption === 'z-a'
                          ? 'bg-purple-100 font-semibold text-purple-700'
                          : 'text-foreground'
                          }`}
                      >
                      ...
                      <DropdownMenuItem
                        ...
                        className={`group mx-1 cursor-pointer rounded-md px-3 py-2.5 text-sm transition-colors hover:bg-purple-50 ${sortOption === 'price-asc'
                          ? 'bg-purple-100 font-semibold text-purple-700'
                          : 'text-foreground'
                          }`}
                      >
                      ...
                      <DropdownMenuItem
                        ...
                        className={`group mx-1 cursor-pointer rounded-md px-3 py-2.5 text-sm transition-colors hover:bg-purple-50 ${sortOption === 'price-desc'
                          ? 'bg-purple-100 font-semibold text-purple-700'
                          : 'text-foreground'
                          }`}
                      >
